...
@constraint(model, theta*x - m .<= epsilon)
...
FileIO.save(File(format"PNG", "Cell_noisy_608_var3_0.03.png"), img)
#FileIO.save(File(format"PNG", "Cell_noisy_1014_var3_0.03.png"), img)
#FileIO.save(File(format"PNG", "Cell_noisy_1521_var3_0.03.png"), img)
#FileIO.save(File(format"PNG", "Cell_noisy_3042_var3_0.03.png"), img)
